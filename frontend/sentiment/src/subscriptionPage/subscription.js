            ...
            {subscriptions.map((product) => (
              <li key={product.productId} className="relative">
                <div className="flex items-center justify-between  py-2 px-2 border border-gray-700 rounded-lg mb-2 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-200 transition duration-300">
                  <span
                    onClick={() =>
                      (window.location.href = `/sentiment/${product.productId}`)
                    }
                  ...
                  <div className="flex">
                    ...
                    <button onClick={() => handleUnsubscribe(product.productId)} className="text-sm text-white bg-red-500 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-200 dark:focus:ring-red-800 font-medium rounded-lg py-1 px-3">
                      Unsubscribe
                    </button>
                  </div>
                </div>
